...
final class MessageFilter
{
    ...
    /**
     * When recipients.include is set, a message with no to/cc recipients is rejected (fails closed).
     */
    ...
    private function isAutoGenerated(ImapMessage $m): bool
    {
        ...
        if (in_array($precedence, ['bulk', 'list', 'junk'], true)) { // 'junk' added beyond bulk/list as a hardening
            return true;
        }
